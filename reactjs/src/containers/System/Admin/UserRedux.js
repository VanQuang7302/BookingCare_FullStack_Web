...
class UserRedux extends Component {
    ...
    handleOnchangeImage =async(event) =>{
        ...
        if (file){
            ...
            console.log('hoidanit base 64',base64)
    ...
    render() {
        ...
        let idGetGenders =this.props.isLoadingGender;
        ...
        return (
            <div className='user-redux-container'>
                <div className="title" >UserRedux quangbeo</div>
                <div className='user-redux-body'>
                    <div className="container" >
                        <div className="row" >

                            <div className='col-12 my-3'>{idGetGenders === true ? 'Loading genders' : ''}</div>
